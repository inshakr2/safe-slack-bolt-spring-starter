...
public abstract class AbstractAppHomeOpenedEventHandler implements BoltHandler {

    private static final Logger log = LoggerFactory.getLogger(AbstractAppHomeOpenedEventHandler.class);
    ...
    public final Response handleSafely(EventsApiPayload<AppHomeOpenedEvent> payload, EventContext ctx) {
        try {
            ...
            log.error("App home opened event handler failed. identifier={}, message={}", getEventIdentifier(), e.getMessage(), e);
