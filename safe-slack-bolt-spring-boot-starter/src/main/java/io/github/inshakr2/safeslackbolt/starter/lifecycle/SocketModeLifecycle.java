package io.github.inshakr2.safeslackbolt.starter.lifecycle;

import com.slack.api.bolt.App;
import com.slack.api.bolt.socket_mode.SocketModeApp;
import io.github.inshakr2.safeslackbolt.starter.config.SafeSlackBoltProperties;
...
public class SocketModeLifecycle implements DisposableBean {
    ...
    private final SafeSlackBoltProperties properties;
    private final Object monitor = new Object();
    private SocketModeApp socketModeApp;

    public SocketModeLifecycle(App app, SafeSlackBoltProperties properties) {
        this.app = app;
