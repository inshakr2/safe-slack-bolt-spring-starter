package io.github.inshakr2.safeslackbolt.core.handler.shortcut;
...
public abstract class AbstractSafeGlobalShortcutHandler implements SafeBoltHandler {

    private static final Logger log = LoggerFactory.getLogger(AbstractSafeGlobalShortcutHandler.class);
    ...
    public final Response handleSafely(GlobalShortcutRequest req, GlobalShortcutContext ctx) {
        try {
            ...
            log.error("Safe global shortcut handler failed. callbackId={}, message={}", getCallbackId(), e.getMessage(), e);
